<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Receptionists.aspx.cs" Inherits="Clinic_MS.Receptionists" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-container">
                    <h4><span>Receptionists</span></h4>
                    <form id="appointmentForm" runat="server">
                        <div class="form-row">
                            <div class="form-group col-lg-4">
                                <label for="inputReceptionists">Name</label>
                                <asp:TextBox ID="inputReceptionists" runat="server" CssClass="form-control" placeholder=""></asp:TextBox>
                            </div>
                            <div class="form-group col-lg-4">
